...
module Visual =
    ...
    let RunVisualBase (paras: Params) (src: string) : Result<VisOutput, string list>  = 
        ...
        let runOpts = VisualOpts + sprintf " --meminstsize:0x%x " VTestSpec.dataSectionStart
    ...
    /// Adds prelude, postlude to assembly code to detect flags values.
    ...
    let RunVisualWithFlagsOut paras src =
        ...
        RunVisual {paras with Prelude=main; Postlude=post} src
